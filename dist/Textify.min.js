...
var _default = /*#__PURE__*/function (_Animation) {
  ...
  function _default(_ref) {
    ...
    var defaults = {
      ...
      delay: 0.1,
      fade: true,
      fadeEasing: _Utils_easing__WEBPACK_IMPORTED_MODULE_9__.cssEasing["default"],
      top: false,
      rotation: 0,
    ...
    value: function animateIn() {
      ...
      lodash_each__WEBPACK_IMPORTED_MODULE_7___default()(this.lines, function (line, lineIndex) {
        lodash_each__WEBPACK_IMPORTED_MODULE_7___default()(line, function (word) {
          word.style.transition = "transform ".concat(_this2.options.duration, "s ").concat(lineIndex * _this2.options.delay, "s ").concat(_this2.options.easing, ", opacity ").concat(_this2.options.duration - 0.1, "s ").concat(lineIndex * _this2.options.delay, "s ").concat(_this2.options.fadeEasing);
...
var Textify = /*#__PURE__*/function () {
  ...
  function Textify() {
    ...
    var defaults = {
      ...
      top: false,
      rotation: 0,
      fadeEasing: _Utils_easing__WEBPACK_IMPORTED_MODULE_5__.cssEasing["default"],
    ...
    this.animation = (0,_Utils_dom__WEBPACK_IMPORTED_MODULE_3__.mapEach)(this.element, function (element) {
      return new _Animations_Text__WEBPACK_IMPORTED_MODULE_2__["default"]({
        ...
        options: {
          ...
          fadeEasing: _this.controller.fadeEasing,
