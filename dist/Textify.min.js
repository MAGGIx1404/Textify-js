...
function split(_ref) {
  var _ref$expression = _ref.expression,
      expression = _ref$expression === void 0 ? " " : _ref$expression,
      _ref$append = _ref.append,
      append = _ref$append === void 0 ? true : _ref$append;

  var element = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelectorAll("[data-textify-animation]"));
  ...
  var innerHTML = "";
  lodash_each__WEBPACK_IMPORTED_MODULE_1___default()(words, function (line) {
    if (line.indexOf("<br>") > -1) {
      var lines = line.split("<br>");
      lodash_each__WEBPACK_IMPORTED_MODULE_1___default()(lines, function (line, index) {
  ...
  if (append) {
    lodash_each__WEBPACK_IMPORTED_MODULE_1___default()(spans, function (span) {
...
function calculate(spans) {
  ...
  lodash_each__WEBPACK_IMPORTED_MODULE_1___default()(spans, function (span, index) {
...
function splitText(text, expression) {
  ...
  var words = [];
  lodash_each__WEBPACK_IMPORTED_MODULE_1___default()(splits, function (item, index) {
    if (index > 0) {
      words.push("<br>");
    }
    ...
    var link = "";
    var innerHTML = [];
    lodash_each__WEBPACK_IMPORTED_MODULE_1___default()(words, function (word) {
...
/* harmony import */ var _Utils_easing__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Utils/easing */ "./src/Utils/easing.js");
/* harmony import */ var _Utils_texts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Utils/texts */ "./src/Utils/texts.js");
/* harmony import */ var _Components_Animation__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Components/Animation */ "./src/Components/Animation.js");
...
var Textify = /*#__PURE__*/function (_Animation) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(Textify, _Animation);

  var _super = _createSuper(Textify);

  function Textify() {
    var _this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, Textify);

    // if(!element || !browserCheck()) return;
    var lines = [];
    var element = document.querySelectorAll("[data-textify-animation]"); // const paragraphs = element.querySelectorAll("h1, h2, p");
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Textify, [{
    key: "animateIn",
    value: function animateIn() {
      var _this2 = this;

      (0,_babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_3__["default"])((0,_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__["default"])(Textify.prototype), "animateIn", this).call(this);

      (0,lodash__WEBPACK_IMPORTED_MODULE_7__.each)(this.lines, function (line, lineIndex) {
        (0,lodash__WEBPACK_IMPORTED_MODULE_7__.each)(line, function (word) {
          word.style.transition = "transform 1.45s ".concat(lineIndex * 0.1, "s ").concat(_Utils_easing__WEBPACK_IMPORTED_MODULE_8__.cssEasing["default"], ", opacity 1s ").concat(lineIndex * 0.1, "s ").concat(_Utils_easing__WEBPACK_IMPORTED_MODULE_8__.cssEasing);
    ...
    value: function animateOut() {
      ...
      (0,_babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_3__["default"])((0,_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__["default"])(Textify.prototype), "animateOut", this).call(this);

      (0,lodash__WEBPACK_IMPORTED_MODULE_7__.each)(this.lines, function (line) {
        (0,lodash__WEBPACK_IMPORTED_MODULE_7__.each)(line, function (word) {
          word.style[_this3.transformPrefix] = "translateY(-200%) rotate(-20deg)";
  ...
  return Textify;
}(_Components_Animation__WEBPACK_IMPORTED_MODULE_10__["default"]);
